module.exports = {
    ...
    run: async (client, message, args) => {
        try {
            ...
            if (songislive === true) return message.channel.send("생방송은 과부하 문제로 인하여 필터 적용이 불가합니다.")
            if ((args[0] === "끄기" || args[0] === "off") && queue.filter) client.distube.setFilter(message, false)
            ...
            else client.distube.setFilter(message, args[0])
